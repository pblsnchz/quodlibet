...
_TAGS = dict((t.name, t) for t in [
    ...
    T("lastskipped", "n", _("last skipped")),
    T("average_loudness", "umn", _("average loudness")),
    T("beats_count", "umn", _("beats count")),
    T("chords_changes_rate", "umn", _("chords changes rate")),
    T("chords_key", "um", _("key")),
    T("chords_number_rate", "umn", _("chords number rate")),
    T("chords_scale", "um", _("chords scale")),
    T("danceable", "umn", _("danceable")),
    T("dynamic_complexity", "umn", _("dynamic complexity")),
    T("gender", "um", _("gender")),
    T("genre_dortmund", "um", _("genre dortmund")),
    T("genre_electronic", "um", _("genre electronic")),
    T("genre_rosamerica", "um", _("genre rosamerica")),
    T("genre_tzanetakis", "um", _("genre tzanetakis")),
    T("ismir04_rhythm", "um", _("ismir04 rhythm")),
    T("key_strength", "umn", _("key strength")),
    T("mood_acoustic", "umn", _("mood acoustic")),
    T("mood_aggressive", "umn", _("mood aggressive")),
    T("mood_electronic", "umn", _("mood electronic")),
    T("mood_happy", "umn", _("mood happy")),
    T("mood_party", "umn", _("mood party")),
    T("mood_relaxed", "umn", _("mood relaxed")),
    T("mood_sad", "umn", _("mood sad")),
    T("onset_rate", "umn", _("onset rate")),
    T("timbre", "umn", _("timbre")),
    T("tonal", "umn", _("tonal")),
    T("tuning_diatonic_strength", "umn", _("tuning diatonic strength")),
    T("tuning_frequency", "umn", _("tuning frequency")),
    T("voice_instrumental", "um", _("voice/instrumental")),
